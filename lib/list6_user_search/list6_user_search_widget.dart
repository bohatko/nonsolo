...
import 'list6_user_search_model.dart';
export 'list6_user_search_model.dart';

class List6UserSearchWidget extends StatefulWidget {
  const List6UserSearchWidget({Key? key}) : super(key: key);

  @override
  _List6UserSearchWidgetState createState() => _List6UserSearchWidgetState();
}

class _List6UserSearchWidgetState extends State<List6UserSearchWidget> {
  late List6UserSearchModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => List6UserSearchModel());
