...
class _DeliveryMethodWidgetState extends State<DeliveryMethodWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DeliveryMethodModel());
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                Text(
                  FFLocalizations.of(context).getText(
                    'a26kma3w' /* Выберите способ доставки */,
                  ),
 ...
 который ... */
                      ...
                      Text(
                        FFLocalizations.of(context).getText(
                          '3nkguz23' /* Или закажите доставку курьером */,
                        ),
                        style: FlutterFlowTheme.of(context).bodyMedium,
                      ),
                      Padding(
                                  ...
                                  children: [
                                    Padding(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          Image.asset(
                                            'assets/images/2023-04-02_15-17-57.jpg',
                                            width: 120.0,
                                            height: 145.0,
                                            fit: BoxFit.contain,
                                          ),
