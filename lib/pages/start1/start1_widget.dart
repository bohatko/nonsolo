...
import '/pages/start2/start2_widget.dart';
            ...
            child: Column(
              ...
              children: [
                Column(
                  ...
                  children: [
                    SvgPicture.asset(
                      'assets/images/undraw_breakfast_psiw_(1).svg',
                    ...
                    Padding(
                      ...
                      child: Text(
                        FFLocalizations.of(context).getText(
                          'sdcgo1zf' /* Заказывайте еду в нашем рестор... */,
                        ),
